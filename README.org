...
single bullet-proof package. It combines the aesthetic centered child-frames, the named-instance multiplexing of ~toggle-term.el~, and the TRAMP-aware scope-locking of ~vterm-toggle~.
